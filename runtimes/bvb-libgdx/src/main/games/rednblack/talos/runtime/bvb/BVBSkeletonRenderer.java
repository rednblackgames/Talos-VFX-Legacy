...
public class BVBSkeletonRenderer {
    ...
    /**
     * Renders the specified skeleton. If the batch is a PolygonSpriteBatch, {@link #draw(ParticleRenderer, PolygonSpriteBatch, SkeletonContainer, Skeleton)} is
     * called. If the batch is a TwoColorPolygonBatch, {@link #draw(ParticleRenderer, TwoColorPolygonBatch, SkeletonContainer, Skeleton)} is called. Otherwise the
     ...
     * next.
     */
    public void draw(ParticleRenderer particleRenderer, SkeletonContainer skeletonContainer, Skeleton skeleton) {
        ...
        for (int i = 0, n = skeleton.getDrawOrder().size; i < n; i++) {
            ...
            if (attachment instanceof RegionAttachment) {
                ...
                if (attachmentSkeleton != null)
                    draw(particleRenderer, skeletonContainer, attachmentSkeleton); //TODO This is messed up
            }
     ...
     * next.
     */
    public void draw(ParticleRenderer particleRenderer, PolygonSpriteBatch batch, SkeletonContainer skeletonContainer, Skeleton skeleton) {
        if (batch == null) throw new IllegalArgumentException("batch cannot be null.");
        if (skeleton == null) throw new IllegalArgumentException("skeleton cannot be null.");
        if (skeletonContainer == null) throw new IllegalArgumentException("skeleton container cannot be null.");
     ...
     * next.
     */
    public void draw(ParticleRenderer particleRenderer, TwoColorPolygonBatch batch, SkeletonContainer skeletonContainer, Skeleton skeleton) {
        if (batch == null) throw new IllegalArgumentException("batch cannot be null.");
        if (skeleton == null) throw new IllegalArgumentException("skeleton cannot be null.");
        if (skeletonContainer == null) throw new IllegalArgumentException("skeleton container cannot be null.");
